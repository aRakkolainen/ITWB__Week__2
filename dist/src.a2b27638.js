...
function insertNewRow(givenUsername) {
  ...
  var givenEmail = document.getElementById("input-email").value;
  var givenAddress = document.getElementById("input-address").value;
  var newRow = document.createElement("tr");
  var numberOfRows = document.getElementById("information-table").rows.length - 1;
  newRow.setAttribute("id", "row" + numberOfRows);
  var usernameCell = document.createElement("td");
  usernameCell.setAttribute("id", "username" + numberOfRows);
  var emailCell = document.createElement("td");
  var addressCell = document.createElement("td");
  var adminstatusCell = document.createElement("td");
  ...
  var adminStatusCB = document.getElementById("input-admin");
...
function checkUsername(givenUsername) {
  ...
  if (usernameExistence === true) {
    ...
    var profilePic = document.getElementById(imgID);
    var currentImgSrc = profilePic.src;
    var imageFile = document.getElementById("input-image").files[0];
    var newImgSrc = "";
    if (!imageFile) return;
...
submitBtn.addEventListener("click", function () {
  var givenUsername = document.getElementById("input-username").value;
  checkUsername(givenUsername);
});
var emptyTableBtn = document.getElementById("empty-table");
